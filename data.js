...
const shopsData = [
    ...
    {
        name: "ねぎ福", // 既存の"ねぎ横"を"ねぎ福"に変更し、情報を統合
        area: "須坂",
    ...
    },
    {
        ...
        holiday: "毎週週末限定",
        phone: null, // 写真に記載なし
        address: null, // 写真に記載なし
        comment: "毎週週末限定！いろんなカレー号 今年は週末毎に、いろんなキッチンカーが順番でカレーフェスに参加するよ！どんなお店がいつ登場するのか、インスタをチェックしていてね。",
        isRewardSpot: false,
        menus: [], // メニュー名、価格は写真に記載なし
        eatIn: true,
        takeOut: true,
        chotashi: null
    },
